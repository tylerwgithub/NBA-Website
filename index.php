...
<!-- Content -->
<div class="w3-content" style="max-width:800px;margin-top:80px;margin-bottom:80px">

  <div class="w3-panel">
    <h1><b>COP 5725: NBA Data Management System</b></h1>
    <p></p>
  </div>
  ...
  <div class="w3-container">
    <div class="w3-display-container mySlides">
      ...
      <div class="w3-display-topleft w3-container w3-padding-32">
        <span class="w3-white w3-padding-large w3-animate-bottom">LeBron leaves early, but Lakers...</span>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="/images/2.jpg" style="width:100%">
      <div class="w3-display-topright w3-container w3-padding-32">
        <span class="w3-white w3-padding-large w3-animate-bottom">News</span>
      </div>
    </div>
    <div class="w3-display-container mySlides">
      <img src="/images/3.jpg" style="width:100%">
      <div class="w3-display-topleft w3-container w3-padding-32">
        <span class="w3-white w3-padding-large w3-animate-bottom">Kambi to offer NBA updates through in-game props</span>
      </div>
    </div>
...
// $s = oci_parse($connection, 'select * from CITY');
// oci_execute($s);
// oci_fetch_all($s, $res);
// echo "<pre>\n";
// var_dump($res);
...
$query = "select * from MATCH WHERE ROWNUM <= 10";
